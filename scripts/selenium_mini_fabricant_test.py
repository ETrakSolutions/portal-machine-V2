...
CAS = [
    ...
    ('Hyundai',     '2026', 'HX90A',     True,  'HD Hyundai : premier compact de 9 t'),
    ('Wacker Neuson','2026', 'ET145',    True,  'Wacker Neuson : « Compact Excavator ET145 »'),
    ('Case',        '2026', 'CX80C',     False, 'Case : CX75C SR et + = MIDI'),
    ('Mecalac',     '2026', '10MCR',     False, 'Mecalac : aucune gamme mini (skid-excavator)'),
    ('Komatsu',     '2026', 'PW98MR-10', False, 'Komatsu Europe : Wheeled MIDI Excavator'),
